...
import requests 
import pickle
# had to changed to in pydriller. Renamed RepositioryMinding to Repositiory
from pydriller import Repository as RepositoryMining
#RepositoryMining.traverse_commits.modified_file = RepositoryMining.traverse_commits.modifications 
...
with open('all_commits.json', 'r') as infile:
  try:
    ...
    print("no existing scapped commits")
